...
Parameters should be update through `bldc/applications/user_appconf.h` and `bldc/applications/user_mcconf.h`.
When Calibration is updated hw name should also be changed here : `bldc/hwconf/makerbase/hw_mksesc_84_100_hp.h:24`

It is also possible to change the test version here : `bldc/conf_general.h:27`. It will change the status of the firmware in vesc_tool (0 = STABLE, 1 = BETA 1, ...).
